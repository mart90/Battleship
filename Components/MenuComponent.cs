...
namespace MBRD.Components
{
    public class MenuComponent
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            Point p = InputComponent.MouseState.Position;
            ...
            if (!mouseOver && (InputComponent.CheckKeyReleased(Keys.Up)))
            {
                selectedIndex--;
                if (selectedIndex < 0)
                    selectedIndex = menuItems.Count - 1;
            }
            else if (!mouseOver && (InputComponent.CheckKeyReleased(Keys.Down)))
            {
                selectedIndex++;
